...
describe('Button', () => {
	...
	it('applies correct styles based on props', () => {
		...
		expect(container.firstChild).toHaveClass('bg-gradient-to-r from-orange-400 to-orange-500');
		expect(container.firstChild).not.toHaveClass('bg-neutral-700');

		rerender(<Button disabled>Disabled</Button>);
		expect(container.firstChild).not.toHaveClass('bg-gradient-to-r from-orange-400 to-orange-500');
